...
public:
	...
	float                                         LayerWidthRatio;                                   // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SideFalloff;                                       // 0x001C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LeftSideFalloffFactor;                             // 0x0020(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RightSideFalloffFactor;                            // 0x0024(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LeftSideLayerFalloffFactor;                        // 0x0028(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RightSideLayerFalloffFactor;                       // 0x002C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EndFalloff;                                        // 0x0030(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FLandscapeSplineSegmentConnection) == 0x000038, "Wrong size on FLandscapeSplineSegmentConnection");
...
static_assert(offsetof(FLandscapeSplineSegmentConnection, Width) == 0x000014, "Member 'FLandscapeSplineSegmentConnection::Width' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, LayerWidthRatio) == 0x000018, "Member 'FLandscapeSplineSegmentConnection::LayerWidthRatio' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, SideFalloff) == 0x00001C, "Member 'FLandscapeSplineSegmentConnection::SideFalloff' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, LeftSideFalloffFactor) == 0x000020, "Member 'FLandscapeSplineSegmentConnection::LeftSideFalloffFactor' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, RightSideFalloffFactor) == 0x000024, "Member 'FLandscapeSplineSegmentConnection::RightSideFalloffFactor' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, LeftSideLayerFalloffFactor) == 0x000028, "Member 'FLandscapeSplineSegmentConnection::LeftSideLayerFalloffFactor' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, RightSideLayerFalloffFactor) == 0x00002C, "Member 'FLandscapeSplineSegmentConnection::RightSideLayerFalloffFactor' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentConnection, EndFalloff) == 0x000030, "Member 'FLandscapeSplineSegmentConnection::EndFalloff' has a wrong offset!");
