...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_RacingWheel_4x2s_C">();
	}
	static class UBP_RacingWheel_4x2s_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBP_RacingWheel_4x2s_C>();
	}
};
