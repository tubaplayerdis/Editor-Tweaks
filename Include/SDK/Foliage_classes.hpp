...
static_assert(offsetof(UFoliageType, ChangeCount) == 0x0003E8, "Member 'UFoliageType::ChangeCount' has a wrong offset!");
static_assert(offsetof(UFoliageType, RuntimeVirtualTextures) == 0x0003F0, "Member 'UFoliageType::RuntimeVirtualTextures' has a wrong offset!");
static_assert(offsetof(UFoliageType, VirtualTextureCullMips) == 0x000400, "Member 'UFoliageType::VirtualTextureCullMips' has a wrong offset!");
static_assert(offsetof(UFoliageType, VirtualTextureRenderPassType) == 0x000404, "Member 'UFoliageType::VirtualTextureRenderPassType' has a wrong offset!");
...
static_assert(sizeof(UFoliageType_Actor) == 0x000420, "Wrong size on UFoliageType_Actor");
static_assert(offsetof(UFoliageType_Actor, ActorClass) == 0x000408, "Member 'UFoliageType_Actor::ActorClass' has a wrong offset!");
static_assert(offsetof(UFoliageType_Actor, bShouldAttachToBaseComponent) == 0x000410, "Member 'UFoliageType_Actor::bShouldAttachToBaseComponent' has a wrong offset!");
