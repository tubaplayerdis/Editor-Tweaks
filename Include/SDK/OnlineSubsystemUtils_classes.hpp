...
static_assert(sizeof(UJoinSessionCallbackProxy) == 0x000190, "Wrong size on UJoinSessionCallbackProxy");
...
{
public:
	uint8                                         Pad_28[0x1A8];                                     // 0x0028(0x01A8)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsFromInvite;                                     // 0x01D0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHandlingDisconnect;                               // 0x01D1(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UOnlineSessionClient) == 0x0001D8, "Wrong size on UOnlineSessionClient");
static_assert(offsetof(UOnlineSessionClient, bIsFromInvite) == 0x0001D0, "Member 'UOnlineSessionClient::bIsFromInvite' has a wrong offset!");
static_assert(offsetof(UOnlineSessionClient, bHandlingDisconnect) == 0x0001D1, "Member 'UOnlineSessionClient::bHandlingDisconnect' has a wrong offset!");
