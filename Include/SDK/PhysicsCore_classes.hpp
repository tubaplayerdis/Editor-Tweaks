...
static_assert(offsetof(UPhysicsSettingsCore, CollisionDominancePairs) == 0x000078, "Member 'UPhysicsSettingsCore::CollisionDominancePairs' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bSimulateSkeletalMeshOnDedicatedServer) == 0x000088, "Member 'UPhysicsSettingsCore::bSimulateSkeletalMeshOnDedicatedServer' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, DefaultShapeComplexity) == 0x000089, "Member 'UPhysicsSettingsCore::DefaultShapeComplexity' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, SolverOptions) == 0x00008C, "Member 'UPhysicsSettingsCore::SolverOptions' has a wrong offset!");
