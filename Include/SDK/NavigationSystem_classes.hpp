...
static_assert(sizeof(UNavLinkComponent) == 0x0004D0, "Wrong size on UNavLinkComponent");
static_assert(offsetof(UNavLinkComponent, Links) == 0x0004B8, "Member 'UNavLinkComponent::Links' has a wrong offset!");
...
static_assert(sizeof(UNavLinkRenderingComponent) == 0x0004B0, "Wrong size on UNavLinkRenderingComponent");
...
static_assert(sizeof(UNavMeshRenderingComponent) == 0x0004C0, "Wrong size on UNavMeshRenderingComponent");
...
static_assert(sizeof(UNavTestRenderingComponent) == 0x0004B0, "Wrong size on UNavTestRenderingComponent");
