...
static_assert(alignof(GridPanel_SetCellSizeOverride) == 0x000004, "Wrong alignment on GridPanel_SetCellSizeOverride");
static_assert(sizeof(GridPanel_SetCellSizeOverride) == 0x000008, "Wrong size on GridPanel_SetCellSizeOverride");
static_assert(offsetof(GridPanel_SetCellSizeOverride, Override) == 0x000000, "Member 'GridPanel_SetCellSizeOverride::Override' has a wrong offset!");
...
static_assert(alignof(GridPanel_SetSlotSpacing) == 0x000004, "Wrong alignment on GridPanel_SetSlotSpacing");
static_assert(sizeof(GridPanel_SetSlotSpacing) == 0x000008, "Wrong size on GridPanel_SetSlotSpacing");
static_assert(offsetof(GridPanel_SetSlotSpacing, Spacing) == 0x000000, "Member 'GridPanel_SetSlotSpacing::Spacing' has a wrong offset!");
...
static_assert(alignof(HorizontalBox_SetSlotSpacing) == 0x000004, "Wrong alignment on HorizontalBox_SetSlotSpacing");
static_assert(sizeof(HorizontalBox_SetSlotSpacing) == 0x000004, "Wrong size on HorizontalBox_SetSlotSpacing");
static_assert(offsetof(HorizontalBox_SetSlotSpacing, InSpacing) == 0x000000, "Member 'HorizontalBox_SetSlotSpacing::InSpacing' has a wrong offset!");
...
static_assert(alignof(MultiLineEditableTextBox_SetAllowMultiLine) == 0x000001, "Wrong alignment on MultiLineEditableTextBox_SetAllowMultiLine");
static_assert(sizeof(MultiLineEditableTextBox_SetAllowMultiLine) == 0x000001, "Wrong size on MultiLineEditableTextBox_SetAllowMultiLine");
static_assert(offsetof(MultiLineEditableTextBox_SetAllowMultiLine, bInAllowMultiLine) == 0x000000, "Member 'MultiLineEditableTextBox_SetAllowMultiLine::bInAllowMultiLine' has a wrong offset!");
...
static_assert(alignof(MultiLineEditableTextBox_SetIsPassword) == 0x000001, "Wrong alignment on MultiLineEditableTextBox_SetIsPassword");
static_assert(sizeof(MultiLineEditableTextBox_SetIsPassword) == 0x000001, "Wrong size on MultiLineEditableTextBox_SetIsPassword");
static_assert(offsetof(MultiLineEditableTextBox_SetIsPassword, bInIsPassword) == 0x000000, "Member 'MultiLineEditableTextBox_SetIsPassword::bInIsPassword' has a wrong offset!");
...
static_assert(alignof(ScrollBox_SetSlotSpacing) == 0x000004, "Wrong alignment on ScrollBox_SetSlotSpacing");
static_assert(sizeof(ScrollBox_SetSlotSpacing) == 0x000004, "Wrong size on ScrollBox_SetSlotSpacing");
static_assert(offsetof(ScrollBox_SetSlotSpacing, NewSpacing) == 0x000000, "Member 'ScrollBox_SetSlotSpacing::NewSpacing' has a wrong offset!");
...
static_assert(alignof(VerticalBox_SetSlotSpacing) == 0x000004, "Wrong alignment on VerticalBox_SetSlotSpacing");
static_assert(sizeof(VerticalBox_SetSlotSpacing) == 0x000004, "Wrong size on VerticalBox_SetSlotSpacing");
static_assert(offsetof(VerticalBox_SetSlotSpacing, InSpacing) == 0x000000, "Member 'VerticalBox_SetSlotSpacing::InSpacing' has a wrong offset!");
...
static_assert(alignof(UniformGridPanel_SetSlotSpacing) == 0x000004, "Wrong alignment on UniformGridPanel_SetSlotSpacing");
static_assert(sizeof(UniformGridPanel_SetSlotSpacing) == 0x000008, "Wrong size on UniformGridPanel_SetSlotSpacing");
static_assert(offsetof(UniformGridPanel_SetSlotSpacing, InSlotSpacing) == 0x000000, "Member 'UniformGridPanel_SetSlotSpacing::InSlotSpacing' has a wrong offset!");
