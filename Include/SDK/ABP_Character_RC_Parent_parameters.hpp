...
struct ABP_Character_RC_Parent_C_ExecuteUbergraph_ABP_Character_RC_Parent final
{
public:
	...
	class ABP_RC_Sequence_2_C*                    K2Node_DynamicCast_AsBP_RC_Sequence_2;             // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_Character_RC_Parent_C_BlueprintUpdateAnimation final
{
public:
